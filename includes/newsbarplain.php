...
<div class="container-fluid m-0 p-0">
    <div id="heading">
        <h2 onclick="window.location = 'news.php'">Recent News</h2>
    </div>
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    ...
                    <p class="h5">Read Our Latest News, Blogs and Posts<br><a class="btn btn-light my-2" href="news.php">Here</a></p>
                </div>
            </div>
            ...
            ?>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h2 onclick="window.location = 'news.php'"><?php echo $row['title']; ?></h2>
